...
- **Dev Server URL**: `http://127.0.0.1:5208`
- **Preview URL**: `https://api.chitterchat.co.uk/chipify/projects/259c074a-8e47-4589-be0e-f4808c4837d9/preview`
- **Port**: `5208`
...
4. The dev server is accessible at `http://127.0.0.1:5208`
5. Preview the application using the preview URL: `https://api.chitterchat.co.uk/chipify/projects/259c074a-8e47-4589-be0e-f4808c4837d9/preview`
